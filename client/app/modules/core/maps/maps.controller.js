define(['angular',
    ...
    var module = angular.module('app.modules.core.maps');
    ...
    function MapsController($state, uiGmapGoogleMapApi)
    {
        ...
        switch ( currentState )
        {
            case 'app.modules_maps':
                vm.selectedIndex = 0;
                break;

            case 'app.modules_maps.satellite':
                vm.selectedIndex = 1;
                break;

            case 'app.modules_maps.terrain':
                vm.selectedIndex = 2;
                break;

            case 'app.modules_maps.simple-marker':
                vm.selectedIndex = 3;
                break;

            case 'app.modules_maps.custom-marker':
                vm.selectedIndex = 4;
                break;

            case 'app.modules_maps.info-window':
                vm.selectedIndex = 5;
                break;
